...
export default function UserDetailsModal({
  ...
  return (
    ...
    >
      <div className={`w-full max-w-lg rounded-3xl bg-white shadow-2xl dark:bg-surface-900 border border-surface-200 dark:border-surface-700/60 overflow-hidden transition-all duration-200 ${visible ? 'scale-100 opacity-100' : 'scale-95 opacity-0'}`}>
